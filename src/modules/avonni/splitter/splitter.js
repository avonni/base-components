...
export default class Splitter extends LightningElement {
    ...
    renderedCallback() {
        ...
        if (slotElements.length > 0) {
            ...
            slotElements.forEach(element => {
                if (element.localName === 'avonni-splitter-pane') {
                    containerComponents++;
                }
            });
                ...
                if (element.localName === 'avonni-splitter-pane') {
                    ...
                    if (collapsible && isSeparator) {
                        ...
                        if (
                            ...
                            rightIcon.setAttribute('avonni-splitter_splitter', '');
                    ...
                    if (
                        ...
                        separator.setAttribute('avonni-splitter_splitter', '');
                        ...
                        line.setAttribute('avonni-splitter_splitter', '');
    ...
    colapsedLeft() {
        ...
        if (
            ...
            if (needLeftColapsed) {
                let leftIcon = document.createElement('div');
                leftIcon.setAttribute('avonni-splitter_splitter', '');
                leftIcon.classList.add('left-colapsed');
    ...
    openLeft() {
        ...
        if (renderButtons) {
            if (parent.getAttribute('is-resizable') === 'true') {
                ...
                separatorIcon.setAttribute('avonni-splitter_splitter', '');
                separatorIcon.classList.add(
                    'separator-icon-' + this._orientation
                );
