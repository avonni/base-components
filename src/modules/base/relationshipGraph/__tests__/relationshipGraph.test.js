...
describe('RelationshipGraph', () => {
    ...
    it('Default attributes', () => {
        const element = createElement('base-relationship-graph', {
    ...
    it('groupTheme = default', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(header.classList).not.toContain('slds-theme_shade');
            expect(header.classList).not.toContain('slds-theme_inverse');
            expect(header.classList).toContain('slds-theme_default');
            expect(level.groupTheme).toBe('default');
        });
    });
    ...
    it('groupTheme = shade', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(header.classList).toContain('slds-theme_shade');
            expect(header.classList).not.toContain('slds-theme_inverse');
            expect(header.classList).not.toContain('slds-theme_default');
            expect(level.groupTheme).toBe('shade');
        });
    });

    it('groupTheme = inverse', () => {
        const element = createElement('base-relationship-graph', {
            is: RelationshipGraph
        });
        ...
        return Promise.resolve().then(() => {
            ...
            expect(header.classList).not.toContain('slds-theme_shade');
            expect(header.classList).toContain('slds-theme_inverse');
            expect(header.classList).not.toContain('slds-theme_default');
            expect(level.groupTheme).toBe('inverse');
        });
    });
    ...
    it('itemTheme', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(level.itemTheme).toBe('shade');
        });
    });
