...
describe('Horizontal Activity Timeline', () => {
    ...
    describe('Attributes', () => {
        ...
        describe('Interval min and max dates', () => {
            it('Interval min and max dates', () => {
        ...
        describe('scrollAxisMaxDate and scrollAxisMinDate', () => {
            it('scrollAxisMaxDate and scrollAxisMinDate', () => {
                const defaultFormat = 'dd/MM/yyyy';
                expect(
    ...
    describe('Methods', () => {
        describe('addValidItemsToData', () => {
            it('addValidItemsToData with invalid dates', () => {
        ...
        describe('calculateDaysBetweenDates', () => {
            it('calculateDaysBetweenDates', () => {
                const minDate = new Date(2022, 0, 4);
                const maxDate = new Date(2022, 3, 29);
                expect(
                    element.calculateDaysBetweenDates(minDate, maxDate)
                ).toBe(115);
            });
        });

        describe('computedItemTitle', () => {
            it('computedItemTitle', () => {
        ...
        describe('endIntervalResizing', () => {
            it('endIntervalResizing', () => {
        ...
        describe('setIconInformation', () => {
            it('setIconInformation', () => {
        ...
        describe('validateXMousePosition', () => {
            it('validateXMousePosition', () => {
                ...
                for (const position of positionsSmallerThanMin) {
                    expect(element.validateXMousePosition(position)).toBe(
                        minPosition
                    );
                }
                ...
                for (const position of positionsBiggerThanMax) {
                    expect(
                        Math.ceil(element.validateXMousePosition(position))
                    ).toBe(maxPosition);
                }
