...
* @property {string[]} icons Array of icon names to display after the title. The icon names will be used in the <code>actionclick</code> event fired on click on an icon.
