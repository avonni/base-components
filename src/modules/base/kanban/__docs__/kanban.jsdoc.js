...
* @property {string} prefixIconName Lightning Design System name of the icon displayed before the action label.
* Specify the name in the format 'utility:down' where 'utility' is the category, and 'down' is the specific icon to be displayed.
...
* See <strong>Types and Type Attributes</strong> for more details.
*/
