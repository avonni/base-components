...
import PrimitiveProgressBarBadge from 'c/primitiveProgressBarBadge';
...
describe('PrimitiveProgressBarBadge', () => {
    ...
    it('Default attributes', () => {
        const element = createElement('base-primitive-progress-bar-badge', {
            is: PrimitiveProgressBarBadge
        });
            ...
            borders.forEach((border) => {
                if (border === 'solid') {
                    expect(div.classList).toContain(
                        `avonni-progress-bar-badge-border-style_${border}`
                    );
                } else {
                ...
                expect(div.classList).not.toContain(
                    `avonni-progress-bar-badge-border-vertical-style_${border}`
                );
            });
        });
    });
    ...
    it('variant = default', () => {
        ...
        return Promise.resolve().then(() => {
            variants.forEach((variant) => {
                expect(div.classList).not.toContain(
                    `avonni-progress-bar-badge-border-color_${variant}`
                );
                expect(div.classList).not.toContain(
                    `avonni-progress-bar-badge-border-vertical-color_${variant}`
                );
                expect(badge.classList).not.toContain(
                    `avonni-progress-bar-badge_${variant}`
                );
            });
        });
    });
