/**
 * @typedef {object} AvonniDualListboxOption
 * @name options
 * @property {AvonniDualListboxAvatar} avatar An object with item fields to be rendered as an avatar.
 ...
 */
/**
 * @typedef {object} AvonniDualListboxAvatar
 * @name avatar
