...
describe('PrimitiveRelationshipGraphGroup', () => {
    ...
    it('Default attributes', () => {
        const element = createElement(
            'base-primitive-relationship-graph-group',
            {
    ...
    // items, item-theme and item-actions
    it('items, itemTheme and itemActions', () => {
        const element = createElement(
            'base-primitive-relationship-graph-group',
            {
                is: PrimitiveRelationshipGraphGroup
    ...
    // theme
    // Depends on defaultActions and actionsPosition
    it('theme = default', () => {
        const element = createElement(
            'base-primitive-relationship-graph-group',
            {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(buttons[0].classList).toContain('slds-button_neutral');
            expect(buttons[0].classList).not.toContain('action-button_shade');
            expect(buttons[0].classList).not.toContain('slds-button_inverse');
        });
    });
    ...
    it('theme = shade', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(buttons[0].classList).toContain('slds-button_neutral');
            expect(buttons[0].classList).toContain('action-button_shade');
            expect(buttons[0].classList).not.toContain('slds-button_inverse');
        });
    });
    ...
    it('theme = inverse', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(buttons[0].classList).not.toContain('slds-button_neutral');
            expect(buttons[0].classList).not.toContain('action-button_shade');
            expect(buttons[0].classList).toContain('slds-button_inverse');
        });
    });
